...
public class TransactionListener {
    ...
    public void onMessage(TransactionEvent event) {
        ...
        provider.setExchange("Test1");
        provider.setQueue("");
        provider.setRoutingkey("Test1");
        ...
        System.out.println("TransactionListener :" + JSON.toJSONString(transaction));

        throw new RuntimeException("TransactionListener 异常抛出");
    }
